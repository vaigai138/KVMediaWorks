    ...
    <div className='w-screen fixed top-0 z-20'>
     ...
     <div className="ui-circle -ml-20 -mt-10"/>
      <ul>
        ...
        <li className="mb-5">
          <a className="menu-item" onClick={()=>handleScroll("works")}>
            Works
          </a>
        </li>

        <li className="mb-5">
          <a className="menu-item" onClick={()=>handleScroll("showreel")}>
            ShowReel
          </a>
        </li>

        <li className="mb-5">
          <a className="menu-item" onClick={()=>handleScroll("whatwedo")}>
            Services
          </a>
        </li>
      </ul>
      <button className='h-10 bg-primary text-white text-xs md:text-sm px-6 rounded hover:bg-blue-200 hover:text-primary md' onClick={()=>handleScroll("contact")}>Contact Us</button>
