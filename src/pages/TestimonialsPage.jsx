...
const TestimonialsPage = () => {
  return (
    <div className="bg-background min-h-screen">
      ...
      {/* ═══════════ VIDEO TESTIMONIALS (Left-Right Layout) ═══════════ */}
  ...
  return (
    <div className="w-full max-w-[280px] sm:max-w-[300px]">
      <div className="border border-white/[0.08] rounded-sm overflow-hidden" style={{ backgroundColor: '#0a1e3d' }}>
        ...
        {/* Video — reduced from 9/16 to 9/14 for better viewport fit */}
        ...
        <div className="px-3 py-2.5">
          <p className="text-[0.7rem] text-white/60 leading-relaxed line-clamp-2">
